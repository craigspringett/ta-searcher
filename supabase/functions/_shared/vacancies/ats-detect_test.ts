...
Deno.test('confirmBoard: a feed that answers with jobs confirms, a 404 does not', async () => {
  const s = stubFetch({
    ...
    'https://boards-api.greenhouse.io/v1/boards/monzo/jobs': { body: fixture('greenhouse-monzo.json') },
    'https://api.lever.co/v0/postings/zopa': { body: fixture('lever-zopa.json') },
    'https://api.lever.co/v0/postings/nobody': { status: 404, body: { ok: false, error: 'Document not found' } },
    'https://api.eu.lever.co/v0/postings/nobody': { status: 404, body: { ok: false, error: 'Document not found' } },
