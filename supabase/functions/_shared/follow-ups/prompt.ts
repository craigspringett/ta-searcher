...
const PURPOSE_NOTES: Record<StepPurpose, string> = {
  first: 'This is the first email and the opening of the sequence: nothing has been sent or said before it unless the outcomes below show a call or a message. Say who you are and where from in the first sentence. Then the one thing you can help with, with its evidence, and one line on Big Fish Recruitment. Say you will ring in the next day or two. Do not claim to have called or left a message unless an outcome says so. End with a light question.',
