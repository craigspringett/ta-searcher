...
import { greeting, rememberPhone, rememberedPhone, type OutreachReply } from "@/lib/outreach";
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        {done ? (
          <div className="space-y-3">
            ...
            <p className="text-xs text-muted-foreground">Logged as "Emailed" on this company's Calls.{sequenceStepId ? " The follow-up step is marked sent." : ""} Opens and clicks will show under the contact as they happen.</p>
